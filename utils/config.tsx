        ...
        case 'cloze':
            return {
                ...
                distractors: {
                    ...
                    lest: ['bar', 'if', 'save'],
                    make: ['color', 'fun', 'suit'],
                    spans: ['connects', 'destroys', 'blurs'],
                    lexicon: ['dialog', 'country', 'era'],
                    thrives: ['works', 'turns', 'fails'],
                    actually: ['hardly', 'likely', 'surprisingly'],
                    community: ['society', 'vitality', 'empathy'],
                    insecurity: ['worry', 'fear', 'ridicule'],
                    profitable: ['proud', 'insecure', 'stupid'],
                    subjective: ['sincere', 'objective', 'intentional'],
                    commodified: ['erased', 'caught', 'abandoned'],
                    consequence: ['end', 'reason', 'drive'],
                    precautions: ['worries', 'warnings', 'measures'],
                    'All the while': ['On the contrary', 'Therefore ', 'Speaking of which']
                }
            }

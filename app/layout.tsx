...
export default function RootLayout({
  ...
  return (
    <html lang='en'>
      <body className={clsx(inter.className, !getSubdomain() && 'bg-[radial-gradient(#e5e7eb_1px,transparent_1px)] dark:bg-[radial-gradient(#2D2E2F_1px,transparent_1px)] [background-size:20px_20px]')}>
        <Providers>
          <Header />
          {children}
          <Footer />
